...
fn load_array_i64x2<S: Simd>(simd: S) {
    let a: i64x2<S> = simd.load_array([1_i64, -2_i64]);
    assert_eq!(*a, [1_i64, -2_i64]);
}

#[simd_test]
fn load_array_i64x4<S: Simd>(simd: S) {
    let a = simd.load_array::<i64x4<S>>([1_i64, -2_i64, 3_i64, -4_i64]);
...
fn load_array_i64x8<S: Simd>(simd: S) {
    let a =
        simd.load_array::<i64x8<S>>([1_i64, -2_i64, 3_i64, -4_i64, 5_i64, -6_i64, 7_i64, -8_i64]);
    assert_eq!(
        *a,
...
fn load_array_mask64x8<S: Simd>(simd: S) {
    let a = simd
        .load_array::<mask64x8<S>>([-1_i64, 0_i64, -1_i64, 0_i64, -1_i64, 0_i64, -1_i64, 0_i64]);
    assert_eq!(
        <[i64; 8]>::from(a),
...
fn load_array_i8x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<i8x16<S>>(values);
...
fn load_array_u8x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<u8x16<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_i8x32<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<i8x32<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_u8x32<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<u8x32<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_i8x64<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<i8x64<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_u8x64<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<u8x64<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_i16x8<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<i16x8<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_u16x8<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<u16x8<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_i16x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<i16x16<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_u16x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<u16x16<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_i16x32<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<i16x32<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_u16x32<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<u16x32<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_f32x4<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<f32x4<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_i32x4<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<i32x4<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_u32x4<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<u32x4<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_f32x8<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<f32x8<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_i32x8<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<i32x8<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_u32x8<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<u32x8<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_f32x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<f32x16<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_i32x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<i32x16<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_u32x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<u32x16<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_f64x2<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<f64x2<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_f64x4<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<f64x4<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_f64x8<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<f64x8<S>>(values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_mask8x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<mask8x16<S>>(values);
...
fn load_array_mask8x32<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<mask8x32<S>>(values);
...
fn load_array_mask8x64<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<mask8x64<S>>(values);
...
fn load_array_mask16x8<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<mask16x8<S>>(values);
...
fn load_array_mask16x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<mask16x16<S>>(values);
...
fn load_array_mask16x32<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<mask16x32<S>>(values);
...
fn load_array_mask32x4<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<mask32x4<S>>(values);
...
fn load_array_mask32x8<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<mask32x8<S>>(values);
...
fn load_array_mask32x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array::<mask32x16<S>>(values);
