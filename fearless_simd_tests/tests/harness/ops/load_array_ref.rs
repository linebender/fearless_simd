...
#[simd_test]
fn load_array_ref_mask32x4<S: Simd>(simd: S) {
    let values = [-1_i32, 0_i32, -1_i32, 0_i32];
    let mask = simd.load_array_ref::<mask32x4<S>>(&values);
    assert_eq!(simd.as_array(mask), values);
}

#[simd_test]
fn load_array_ref_i64x2<S: Simd>(simd: S) {
    let values = [1_i64, -2_i64];
    let a = simd.load_array_ref::<i64x2<S>>(&values);
    assert_eq!(*a, values);
}
...
fn load_array_ref_i64x4<S: Simd>(simd: S) {
    ...
    let a = simd.load_array_ref::<i64x4<S>>(&values);
    assert_eq!(*a, values);
}
...
fn load_array_ref_i64x8<S: Simd>(simd: S) {
    ...
    let a = simd.load_array_ref::<i64x8<S>>(&values);
    assert_eq!(*a, values);
}
...
fn load_array_ref_u64x2<S: Simd>(simd: S) {
    ...
    let a = simd.load_array_ref::<u64x2<S>>(&values);
    assert_eq!(*a, values);
}
...
fn load_array_ref_u64x4<S: Simd>(simd: S) {
    ...
    let a = simd.load_array_ref::<u64x4<S>>(&values);
    assert_eq!(*a, values);
}
...
fn load_array_ref_u64x8<S: Simd>(simd: S) {
    ...
    let a = simd.load_array_ref::<u64x8<S>>(&values);
    assert_eq!(*a, values);
}
...
fn load_array_ref_i8x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<i8x16<S>>(&values);
...
fn load_array_ref_u8x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<u8x16<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_i8x32<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<i8x32<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_u8x32<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<u8x32<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_i8x64<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<i8x64<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_u8x64<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<u8x64<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_i16x8<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<i16x8<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_u16x8<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<u16x8<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_i16x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<i16x16<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_u16x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<u16x16<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_i16x32<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<i16x32<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_u16x32<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<u16x32<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_f32x4<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<f32x4<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_i32x4<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<i32x4<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_u32x4<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<u32x4<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_f32x8<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<f32x8<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_i32x8<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<i32x8<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_u32x8<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<u32x8<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_f32x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<f32x16<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_i32x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<i32x16<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_u32x16<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<u32x16<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_f64x2<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<f64x2<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_f64x4<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<f64x4<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
...
fn load_array_ref_f64x8<S: Simd>(simd: S) {
    ...
    let result = simd.load_array_ref::<f64x8<S>>(&values);
    assert_eq!(result.as_slice(), values.as_slice());
}
