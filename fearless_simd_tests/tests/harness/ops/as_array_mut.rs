...
fn as_array_mut_i64x2<S: Simd>(simd: S) {
    ...
    simd.as_array_mut(&mut a)[0] = -2_i64;
...
#[simd_test]
fn as_array_mut_i64x8<S: Simd>(simd: S) {
...
fn as_array_mut_u64x2<S: Simd>(simd: S) {
    ...
    simd.as_array_mut(&mut a)[0] = 2_u64;
...
#[simd_test]
fn as_array_mut_u64x8<S: Simd>(simd: S) {
...
#[simd_test]
fn as_array_mut_u8x32<S: Simd>(simd: S) {
...
#[simd_test]
fn as_array_mut_i8x64<S: Simd>(simd: S) {
...
#[simd_test]
fn as_array_mut_u8x64<S: Simd>(simd: S) {
...
#[simd_test]
fn as_array_mut_u16x16<S: Simd>(simd: S) {
...
#[simd_test]
fn as_array_mut_i16x32<S: Simd>(simd: S) {
...
#[simd_test]
fn as_array_mut_u16x32<S: Simd>(simd: S) {
...
#[simd_test]
fn as_array_mut_i32x8<S: Simd>(simd: S) {
...
#[simd_test]
fn as_array_mut_u32x8<S: Simd>(simd: S) {
...
#[simd_test]
fn as_array_mut_f32x16<S: Simd>(simd: S) {
...
#[simd_test]
fn as_array_mut_i32x16<S: Simd>(simd: S) {
...
#[simd_test]
fn as_array_mut_u32x16<S: Simd>(simd: S) {
...
#[simd_test]
fn as_array_mut_f64x2<S: Simd>(simd: S) {
    let values: [f64; 2] = core::array::from_fn(|i| i as f64 + 1.25_f64);
    let mut expected = values;
    expected[0] = 42.5_f64;
    let mut a = f64x2::from_slice(simd, &values);
    simd.as_array_mut(&mut a)[0] = 42.5_f64;
    assert_eq!(a.as_slice(), expected.as_slice());
}

#[simd_test]
fn as_array_mut_f64x4<S: Simd>(simd: S) {
...
#[simd_test]
fn as_array_mut_f64x8<S: Simd>(simd: S) {
