...
#[simd_test]
fn simd_le_i8x16<S: Simd>(simd: S) {
    let a_values: [i8; 16] = core::array::from_fn(|i| (i % 17) as i8 + 1_i8);
    let b_values: [i8; 16] = core::array::from_fn(|i| ((i % 17) + 2 - 2 * (i % 2)) as i8);
    let a = i8x16::from_slice(simd, &a_values);
    let b = i8x16::from_slice(simd, &b_values);
    ...
    let result = simd.simd_le_i8x16(a, b);
    assert_eq!(<[i8; 16]>::from(result), expected);
}

#[simd_test]
fn simd_le_i8x32<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_i8x32(a, b);
    assert_eq!(<[i8; 32]>::from(result), expected);
}

#[simd_test]
fn simd_le_u8x32<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_u8x32(a, b);
    assert_eq!(<[i8; 32]>::from(result), expected);
}

#[simd_test]
fn simd_le_i8x64<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_i8x64(a, b);
    assert_eq!(<[i8; 64]>::from(result), expected);
}

#[simd_test]
fn simd_le_u8x64<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_u8x64(a, b);
    assert_eq!(<[i8; 64]>::from(result), expected);
}

#[simd_test]
fn simd_le_i16x8<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_i16x8(a, b);
    assert_eq!(<[i16; 8]>::from(result), expected);
}

#[simd_test]
fn simd_le_u16x8<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_u16x8(a, b);
    assert_eq!(<[i16; 8]>::from(result), expected);
}

#[simd_test]
fn simd_le_i16x16<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_i16x16(a, b);
    assert_eq!(<[i16; 16]>::from(result), expected);
}

#[simd_test]
fn simd_le_u16x16<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_u16x16(a, b);
    assert_eq!(<[i16; 16]>::from(result), expected);
}

#[simd_test]
fn simd_le_i16x32<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_i16x32(a, b);
    assert_eq!(<[i16; 32]>::from(result), expected);
}

#[simd_test]
fn simd_le_u16x32<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_u16x32(a, b);
    assert_eq!(<[i16; 32]>::from(result), expected);
}

#[simd_test]
fn simd_le_i32x4<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_i32x4(a, b);
    assert_eq!(<[i32; 4]>::from(result), expected);
}

#[simd_test]
fn simd_le_u32x4<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_u32x4(a, b);
    assert_eq!(<[i32; 4]>::from(result), expected);
}

#[simd_test]
fn simd_le_i32x8<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_i32x8(a, b);
    assert_eq!(<[i32; 8]>::from(result), expected);
}

#[simd_test]
fn simd_le_u32x8<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_u32x8(a, b);
    assert_eq!(<[i32; 8]>::from(result), expected);
}

#[simd_test]
fn simd_le_i32x16<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_i32x16(a, b);
    assert_eq!(<[i32; 16]>::from(result), expected);
}

#[simd_test]
fn simd_le_u32x16<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_u32x16(a, b);
    assert_eq!(<[i32; 16]>::from(result), expected);
}

#[simd_test]
fn simd_le_f64x2<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_f64x2(a, b);
    assert_eq!(<[i64; 2]>::from(result), expected);
}

#[simd_test]
fn simd_le_f64x4<S: Simd>(simd: S) {
    ...
    let result = simd.simd_le_f64x4(a, b);
