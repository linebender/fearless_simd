...
#[simd_test]
fn cvt_i32_f32x4_regular<S: Simd>(simd: S) {
    let a = f32x4::from_slice(simd, &[-101.75, -22.5, 33.875, 404.25]);
    assert_eq!(*a.to_int::<i32x4<_>>(), [-101, -22, 33, 404]);
}

#[simd_test]
fn cvt_i32_f32x8_regular<S: Simd>(simd: S) {
...
#[simd_test]
fn cvt_i32_f32x16_regular<S: Simd>(simd: S) {
