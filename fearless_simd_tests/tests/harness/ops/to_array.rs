...
#[simd_test]
fn to_array_i64x2<S: Simd>(simd: S) {
    let a = i64x2::from_slice(simd, &[1_i64, -2_i64]);
    assert_eq!(a.to_array(), [1_i64, -2_i64]);
}

#[simd_test]
fn to_array_i64x4<S: Simd>(simd: S) {
    let a = i64x4::from_slice(simd, &[1_i64, -2_i64, 3_i64, -4_i64]);
    assert_eq!(a.to_array(), [1_i64, -2_i64, 3_i64, -4_i64]);
}

#[simd_test]
fn to_array_i64x8<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_u64x2<S: Simd>(simd: S) {
    let a = u64x2::from_slice(simd, &[1_u64, 2_u64]);
    assert_eq!(a.to_array(), [1_u64, 2_u64]);
}

#[simd_test]
fn to_array_u64x4<S: Simd>(simd: S) {
    let a = u64x4::from_slice(simd, &[1_u64, 2_u64, 3_u64, 4_u64]);
    assert_eq!(a.to_array(), [1_u64, 2_u64, 3_u64, 4_u64]);
}

#[simd_test]
fn to_array_u64x8<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_i8x16<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_u8x16<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_i8x32<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_u8x32<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_i8x64<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_u8x64<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_i16x8<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_u16x8<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_i16x16<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_u16x16<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_i16x32<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_u16x32<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_f32x4<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_i32x4<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_u32x4<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_f32x8<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_i32x8<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_u32x8<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_f32x16<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_i32x16<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_u32x16<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_f64x2<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_f64x4<S: Simd>(simd: S) {
...
#[simd_test]
fn to_array_f64x8<S: Simd>(simd: S) {
