...
fn and_i16x8<S: Simd>(simd: S) {
    ...
    let result = simd.and_i16x8(a, b);
    assert_eq!(result.as_slice(), expected.as_slice());
}

#[simd_test]
fn and_u16x8<S: Simd>(simd: S) {
    ...
    let result = simd.and_u16x8(a, b);
    assert_eq!(result.as_slice(), expected.as_slice());
}

#[simd_test]
fn and_i16x16<S: Simd>(simd: S) {
    ...
    let result = simd.and_i16x16(a, b);
    assert_eq!(result.as_slice(), expected.as_slice());
}

#[simd_test]
fn and_u16x16<S: Simd>(simd: S) {
    ...
    let result = simd.and_u16x16(a, b);
    assert_eq!(result.as_slice(), expected.as_slice());
}

#[simd_test]
fn and_i16x32<S: Simd>(simd: S) {
    ...
    let result = simd.and_i16x32(a, b);
    assert_eq!(result.as_slice(), expected.as_slice());
}

#[simd_test]
fn and_u16x32<S: Simd>(simd: S) {
    ...
    let result = simd.and_u16x32(a, b);
    assert_eq!(result.as_slice(), expected.as_slice());
}

#[simd_test]
fn and_i32x4<S: Simd>(simd: S) {
    ...
    let result = simd.and_i32x4(a, b);
    assert_eq!(result.as_slice(), expected.as_slice());
}

#[simd_test]
fn and_u32x4<S: Simd>(simd: S) {
    ...
    let result = simd.and_u32x4(a, b);
    assert_eq!(result.as_slice(), expected.as_slice());
}

#[simd_test]
fn and_i32x8<S: Simd>(simd: S) {
    ...
    let result = simd.and_i32x8(a, b);
    assert_eq!(result.as_slice(), expected.as_slice());
}

#[simd_test]
fn and_u32x8<S: Simd>(simd: S) {
    ...
    let result = simd.and_u32x8(a, b);
    assert_eq!(result.as_slice(), expected.as_slice());
}

#[simd_test]
fn and_i32x16<S: Simd>(simd: S) {
    ...
    let result = simd.and_i32x16(a, b);
    assert_eq!(result.as_slice(), expected.as_slice());
}

#[simd_test]
fn and_u32x16<S: Simd>(simd: S) {
    ...
    let result = simd.and_u32x16(a, b);
    assert_eq!(result.as_slice(), expected.as_slice());
}

#[simd_test]
fn and_mask8x32<S: Simd>(simd: S) {
    ...
    let result = simd.and_mask8x32(a, b);
    assert_eq!(<[i8; 32]>::from(result), expected);
}

#[simd_test]
fn and_mask8x64<S: Simd>(simd: S) {
    ...
    let result = simd.and_mask8x64(a, b);
    assert_eq!(<[i8; 64]>::from(result), expected);
}

#[simd_test]
fn and_mask16x8<S: Simd>(simd: S) {
    ...
    let expected: [i16; 8] = core::array::from_fn(|i| a_values[i] & b_values[i]);
    let result = simd.and_mask16x8(a, b);
    assert_eq!(<[i16; 8]>::from(result), expected);
}

#[simd_test]
fn and_mask16x16<S: Simd>(simd: S) {
    ...
    let expected: [i16; 16] = core::array::from_fn(|i| a_values[i] & b_values[i]);
    let result = simd.and_mask16x16(a, b);
    assert_eq!(<[i16; 16]>::from(result), expected);
}

#[simd_test]
fn and_mask16x32<S: Simd>(simd: S) {
    ...
    let expected: [i16; 32] = core::array::from_fn(|i| a_values[i] & b_values[i]);
    let result = simd.and_mask16x32(a, b);
    assert_eq!(<[i16; 32]>::from(result), expected);
}

#[simd_test]
fn and_mask32x4<S: Simd>(simd: S) {
    ...
    let expected: [i32; 4] = core::array::from_fn(|i| a_values[i] & b_values[i]);
    let result = simd.and_mask32x4(a, b);
    assert_eq!(<[i32; 4]>::from(result), expected);
}

#[simd_test]
fn and_mask32x8<S: Simd>(simd: S) {
    ...
    let expected: [i32; 8] = core::array::from_fn(|i| a_values[i] & b_values[i]);
    let result = simd.and_mask32x8(a, b);
    assert_eq!(<[i32; 8]>::from(result), expected);
}

#[simd_test]
fn and_mask32x16<S: Simd>(simd: S) {
    ...
    let expected: [i32; 16] = core::array::from_fn(|i| a_values[i] & b_values[i]);
    let result = simd.and_mask32x16(a, b);
