...
impl From<Avx512vl> for crate::x86::avx::Avx {
...
impl From<Avx512vl> for crate::x86::avx::Avx2 {
    fn from(value: Avx512vl) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
        trampoline!([Avx512vl = value] => "avx512vl", fn() -> crate::x86::avx::Avx2 { crate::x86::avx::Avx2::new() })
    }
}

impl From<Avx512vl> for crate::x86::avx512::Avx512f {
    fn from(value: Avx512vl) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
        trampoline!([Avx512vl = value] => "avx512vl", fn() -> crate::x86::avx512::Avx512f { crate::x86::avx512::Avx512f::new() })
    }
}

impl From<Avx512vl> for crate::x86::v3::F16c {
    fn from(value: Avx512vl) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
        trampoline!([Avx512vl = value] => "avx512vl", fn() -> crate::x86::v3::F16c { crate::x86::v3::F16c::new() })
    }
}

impl From<Avx512vl> for crate::x86::v3::Fma {
    fn from(value: Avx512vl) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
        trampoline!([Avx512vl = value] => "avx512vl", fn() -> crate::x86::v3::Fma { crate::x86::v3::Fma::new() })
    }
}

impl From<Avx512vl> for crate::x86::sse::Sse {
    fn from(value: Avx512vl) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avx512vl> for crate::x86::sse::Sse2 {
    fn from(value: Avx512vl) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
        trampoline!([Avx512vl = value] => "avx512vl", fn() -> crate::x86::sse::Sse2 { crate::x86::sse::Sse2::new() })
    }
}

impl From<Avx512vl> for crate::x86::sse::Sse3 {
    fn from(value: Avx512vl) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avx512vl> for crate::x86::sse::Sse4_1 {
    fn from(value: Avx512vl) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
        trampoline!([Avx512vl = value] => "avx512vl", fn() -> crate::x86::sse::Sse4_1 { crate::x86::sse::Sse4_1::new() })
    }
}

impl From<Avx512vl> for crate::x86::sse::Sse4_2 {
    fn from(value: Avx512vl) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
        trampoline!([Avx512vl = value] => "avx512vl", fn() -> crate::x86::sse::Sse4_2 { crate::x86::sse::Sse4_2::new() })
    }
}

impl From<Avx512vl> for crate::x86::sse::SupplementalSse3 {
    fn from(value: Avx512vl) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
        trampoline!([Avx512vl = value] => "avx512vl", fn() -> crate::x86::sse::SupplementalSse3 { crate::x86::sse::SupplementalSse3::new() })
    }
}

const _: () = {
    assert!(
        core::mem::size_of::<Avx512vl>() == 0,
