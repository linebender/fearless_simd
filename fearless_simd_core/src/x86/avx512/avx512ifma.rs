...
impl From<Avx512ifma> for crate::x86::avx::Avx {
...
impl From<Avx512ifma> for crate::x86::avx::Avx2 {
    fn from(value: Avx512ifma) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avx512ifma> for crate::x86::avx512::Avx512f {
    fn from(value: Avx512ifma) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avx512ifma> for crate::x86::v3::F16c {
    fn from(value: Avx512ifma) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avx512ifma> for crate::x86::v3::Fma {
    fn from(value: Avx512ifma) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avx512ifma> for crate::x86::sse::Sse {
    fn from(value: Avx512ifma) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avx512ifma> for crate::x86::sse::Sse2 {
    fn from(value: Avx512ifma) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avx512ifma> for crate::x86::sse::Sse3 {
    fn from(value: Avx512ifma) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avx512ifma> for crate::x86::sse::Sse4_1 {
    fn from(value: Avx512ifma) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avx512ifma> for crate::x86::sse::Sse4_2 {
    fn from(value: Avx512ifma) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avx512ifma> for crate::x86::sse::SupplementalSse3 {
    fn from(value: Avx512ifma) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
