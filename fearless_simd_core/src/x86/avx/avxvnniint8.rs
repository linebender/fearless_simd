...
impl From<Avxvnniint8> for crate::x86::avx::Avx {
...
impl From<Avxvnniint8> for crate::x86::avx::Avx2 {
    fn from(value: Avxvnniint8) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avxvnniint8> for crate::x86::sse::Sse {
    fn from(value: Avxvnniint8) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avxvnniint8> for crate::x86::sse::Sse2 {
    fn from(value: Avxvnniint8) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avxvnniint8> for crate::x86::sse::Sse3 {
    fn from(value: Avxvnniint8) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avxvnniint8> for crate::x86::sse::Sse4_1 {
    fn from(value: Avxvnniint8) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avxvnniint8> for crate::x86::sse::Sse4_2 {
    fn from(value: Avxvnniint8) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Avxvnniint8> for crate::x86::sse::SupplementalSse3 {
    fn from(value: Avxvnniint8) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
const _: () = {
    assert!(
        core::mem::size_of::<Avxvnniint8>() == 0,
