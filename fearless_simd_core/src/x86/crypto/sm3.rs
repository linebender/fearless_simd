...
///
/// A token indicating that the current CPU has the `sm3` target feature.
///
/// # Example
///
...
unsafe impl TargetFeatureToken for Sm3 {
    ...
    fn vectorize<R>(self, f: impl FnOnce() -> R) -> R {
        ...
        trampoline!([Sm3 = self] => "sm3", <(R)> fn<(R)>(f: impl FnOnce() -> R = f) -> R { f() })
    }
}

impl Sm3 {
    #[cfg(feature = "std")]
    /// Create a new token if the `"sm3"` target feature is detected as enabled.
    ///
    ...
    pub fn try_new() -> Option<Self> {
        ...
        #[cfg(any(target_arch = "x86", target_arch = "x86_64"))]
        if std::arch::is_x86_feature_detected!("sm3") {
...
impl From<Sm3> for crate::x86::avx::Avx {
    fn from(value: Sm3) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
        trampoline!([Sm3 = value] => "sm3", fn() -> crate::x86::avx::Avx { crate::x86::avx::Avx::new() })
    }
}

impl From<Sm3> for crate::x86::sse::Sse {
    fn from(value: Sm3) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Sm3> for crate::x86::sse::Sse2 {
    fn from(value: Sm3) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
        trampoline!([Sm3 = value] => "sm3", fn() -> crate::x86::sse::Sse2 { crate::x86::sse::Sse2::new() })
    }
}

impl From<Sm3> for crate::x86::sse::Sse3 {
    fn from(value: Sm3) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
...
impl From<Sm3> for crate::x86::sse::Sse4_1 {
    fn from(value: Sm3) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
        trampoline!([Sm3 = value] => "sm3", fn() -> crate::x86::sse::Sse4_1 { crate::x86::sse::Sse4_1::new() })
    }
}

impl From<Sm3> for crate::x86::sse::Sse4_2 {
    fn from(value: Sm3) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
        trampoline!([Sm3 = value] => "sm3", fn() -> crate::x86::sse::Sse4_2 { crate::x86::sse::Sse4_2::new() })
    }
}

impl From<Sm3> for crate::x86::sse::SupplementalSse3 {
    fn from(value: Sm3) -> Self {
        // This also serves as a correctness check of the implicitly enabled features.
        trampoline!([Sm3 = value] => "sm3", fn() -> crate::x86::sse::SupplementalSse3 { crate::x86::sse::SupplementalSse3::new() })
    }
}

const _: () = {
    assert!(
        core::mem::size_of::<Sm3>() == 0,
