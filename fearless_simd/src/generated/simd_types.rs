...
use crate::{Bytes, Scalar, Select, Simd, SimdCvtFloat, SimdCvtTruncate, SimdFrom, SimdInto};
...
impl crate::SimdBase<u8, Scalar> for u8 {
    const N: usize = 1;
    type Mask = i8;
    type Block = u8x16<Scalar>;
    #[inline(always)]
    ...
    #[inline(always)]
    fn from_slice(Scalar: Scalar, slice: &[u8]) -> Self {
        slice[0]
    }
    #[inline(always)]
    fn splat(Scalar: Scalar, val: u8) -> Self {
        val
    }
    #[inline(always)]
    fn block_splat(block: Self::Block) -> Self {
...
impl crate::SimdInt<u8, Scalar> for u8 {
    fn simd_eq(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
        -((self == rhs.simd_into(Scalar)) as i8)
    }
...
impl crate::Select<u8> for i8 {
    fn select(self, if_true: u8, if_false: u8) -> u8 {
        if self != 0 { if_true } else { if_false }
    }
}
impl crate::Bytes for u16 {
    type Bytes = u16;
    fn to_bytes(self) -> u16 {
        self
    }
    fn from_bytes(value: u16) -> Self {
        value
    }
}
impl crate::SimdBase<u16, Scalar> for u16 {
    const N: usize = 1;
    type Mask = i16;
    type Block = u16x8<Scalar>;
    #[inline(always)]
    fn witness(&self) -> Scalar {
        Scalar
    }
    ...
    #[inline(always)]
    fn from_slice(Scalar: Scalar, slice: &[u16]) -> Self {
        slice[0]
    }
    #[inline(always)]
    fn splat(Scalar: Scalar, val: u16) -> Self {
        val
    }
    #[inline(always)]
    fn block_splat(block: Self::Block) -> Self {
...
impl crate::SimdInt<u16, Scalar> for u16 {
    fn simd_eq(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
        -((self == rhs.simd_into(Scalar)) as i16)
    }
    fn simd_lt(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
        -((self < rhs.simd_into(Scalar)) as i16)
    }
...
impl crate::Select<u16> for i16 {
    fn select(self, if_true: u16, if_false: u16) -> u16 {
        if self != 0 { if_true } else { if_false }
    }
}
impl crate::Bytes for u32 {
    type Bytes = u32;
    fn to_bytes(self) -> u32 {
        self
    }
    fn from_bytes(value: u32) -> Self {
        value
    }
}
impl crate::SimdBase<u32, Scalar> for u32 {
    const N: usize = 1;
    type Mask = i32;
    type Block = u32x4<Scalar>;
    #[inline(always)]
    fn witness(&self) -> Scalar {
        Scalar
    }
    ...
    #[inline(always)]
    fn from_slice(Scalar: Scalar, slice: &[u32]) -> Self {
        slice[0]
    }
    #[inline(always)]
    fn splat(Scalar: Scalar, val: u32) -> Self {
        val
    }
    #[inline(always)]
    fn block_splat(block: Self::Block) -> Self {
...
impl crate::SimdInt<u32, Scalar> for u32 {
    fn simd_eq(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
        -((self == rhs.simd_into(Scalar)) as i32)
    }
    fn simd_lt(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
        -((self < rhs.simd_into(Scalar)) as i32)
    }
...
impl crate::Select<u32> for i32 {
    fn select(self, if_true: u32, if_false: u32) -> u32 {
        if self != 0 { if_true } else { if_false }
    }
}
impl crate::SimdCvtTruncate<f32> for u32 {
    fn truncate_from(x: f32) -> Self {
        x as Self
    }
}
impl crate::SimdCvtFloat<u32> for f32 {
    fn float_from(x: u32) -> Self {
        x as Self
    }
}
impl crate::Bytes for i8 {
    type Bytes = u8;
    fn to_bytes(self) -> u8 {
        self as u8
    }
...
impl crate::SimdBase<i8, Scalar> for i8 {
    const N: usize = 1;
    type Mask = i8;
    type Block = i8x16<Scalar>;
    #[inline(always)]
    fn witness(&self) -> Scalar {
        Scalar
    }
    ...
    #[inline(always)]
    fn from_slice(Scalar: Scalar, slice: &[i8]) -> Self {
        slice[0]
    }
    #[inline(always)]
    fn splat(Scalar: Scalar, val: i8) -> Self {
        val
    }
    #[inline(always)]
    fn block_splat(block: Self::Block) -> Self {
...
impl crate::SimdInt<i8, Scalar> for i8 {
    fn simd_eq(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
        -((self == rhs.simd_into(Scalar)) as i8)
    }
    fn simd_lt(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
...
impl crate::Select<i8> for i8 {
    fn select(self, if_true: i8, if_false: i8) -> i8 {
        if self != 0 { if_true } else { if_false }
    }
}
impl crate::Bytes for i16 {
    type Bytes = u16;
    fn to_bytes(self) -> u16 {
        self as u16
    }
...
impl crate::SimdBase<i16, Scalar> for i16 {
    const N: usize = 1;
    type Mask = i16;
    type Block = i16x8<Scalar>;
    #[inline(always)]
    fn witness(&self) -> Scalar {
        Scalar
    }
    ...
    #[inline(always)]
    fn from_slice(Scalar: Scalar, slice: &[i16]) -> Self {
        slice[0]
    }
    #[inline(always)]
    fn splat(Scalar: Scalar, val: i16) -> Self {
        val
    }
    #[inline(always)]
    fn block_splat(block: Self::Block) -> Self {
...
impl crate::SimdInt<i16, Scalar> for i16 {
    fn simd_eq(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
        -((self == rhs.simd_into(Scalar)) as i16)
    }
    fn simd_lt(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
...
impl crate::Select<i16> for i16 {
    fn select(self, if_true: i16, if_false: i16) -> i16 {
        if self != 0 { if_true } else { if_false }
    }
}
impl crate::Bytes for i32 {
    type Bytes = u32;
    fn to_bytes(self) -> u32 {
        self as u32
    }
...
impl crate::SimdBase<i32, Scalar> for i32 {
    const N: usize = 1;
    type Mask = i32;
    type Block = i32x4<Scalar>;
    #[inline(always)]
    fn witness(&self) -> Scalar {
        Scalar
    }
    ...
    #[inline(always)]
    fn from_slice(Scalar: Scalar, slice: &[i32]) -> Self {
        slice[0]
    }
    #[inline(always)]
    fn splat(Scalar: Scalar, val: i32) -> Self {
        val
    }
    #[inline(always)]
    fn block_splat(block: Self::Block) -> Self {
...
impl crate::SimdInt<i32, Scalar> for i32 {
    fn simd_eq(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
        -((self == rhs.simd_into(Scalar)) as i32)
    }
    fn simd_lt(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
...
impl crate::Select<i32> for i32 {
    fn select(self, if_true: i32, if_false: i32) -> i32 {
        if self != 0 { if_true } else { if_false }
    }
}
impl crate::SimdCvtTruncate<f32> for i32 {
    fn truncate_from(x: f32) -> Self {
        x as Self
    }
}
impl crate::SimdCvtFloat<i32> for f32 {
    fn float_from(x: i32) -> Self {
        x as Self
    }
}
impl crate::Bytes for f32 {
    type Bytes = u32;
    fn to_bytes(self) -> u32 {
        self.to_bits()
    }
...
impl crate::SimdBase<f32, Scalar> for f32 {
    const N: usize = 1;
    type Mask = i32;
    type Block = f32x4<Scalar>;
    #[inline(always)]
    fn witness(&self) -> Scalar {
        Scalar
    }
    ...
    #[inline(always)]
    fn from_slice(Scalar: Scalar, slice: &[f32]) -> Self {
        slice[0]
    }
    #[inline(always)]
    fn splat(Scalar: Scalar, val: f32) -> Self {
        val
    }
    #[inline(always)]
    fn block_splat(block: Self::Block) -> Self {
...
impl crate::SimdFloat<f32, Scalar> for f32 {
    fn abs(self) -> Self {
        f32::abs(self)
    }
    fn sqrt(self) -> Self {
    ...
    fn copysign(self, rhs: impl SimdInto<Self, Scalar>) -> Self {
        f32::copysign(self, rhs.simd_into(Scalar))
    }
    fn simd_eq(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
        -((self == rhs.simd_into(Scalar)) as i32)
    }
    ...
    fn max(self, rhs: impl SimdInto<Self, Scalar>) -> Self {
        f32::max(self, rhs.simd_into(Scalar))
    }
    fn max_precise(self, rhs: impl SimdInto<Self, Scalar>) -> Self {
        f32::max(self, rhs.simd_into(Scalar))
    }
    fn min(self, rhs: impl SimdInto<Self, Scalar>) -> Self {
        f32::min(self, rhs.simd_into(Scalar))
    }
    fn min_precise(self, rhs: impl SimdInto<Self, Scalar>) -> Self {
        f32::min(self, rhs.simd_into(Scalar))
    }
    fn madd(self, op1: impl SimdInto<Self, Scalar>, op2: impl SimdInto<Self, Scalar>) -> Self {
        self.mul_add(op1.simd_into(Scalar), op2.simd_into(Scalar))
    }
    fn msub(self, op1: impl SimdInto<Self, Scalar>, op2: impl SimdInto<Self, Scalar>) -> Self {
        self.mul_add(op1.simd_into(Scalar), -op2.simd_into(Scalar))
    }
    fn floor(self) -> Self {
        f32::floor(self)
...
impl crate::Select<f32> for i32 {
    fn select(self, if_true: f32, if_false: f32) -> f32 {
        if self != 0 { if_true } else { if_false }
    }
}
impl crate::SimdMask<i8, Scalar> for i8 {
    fn simd_eq(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
        -((self == rhs.simd_into(Scalar)) as i8)
    }
}
impl crate::SimdMask<i16, Scalar> for i16 {
    fn simd_eq(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
        -((self == rhs.simd_into(Scalar)) as i16)
    }
}
impl crate::SimdMask<i32, Scalar> for i32 {
    fn simd_eq(self, rhs: impl SimdInto<Self, Scalar>) -> Self::Mask {
        -((self == rhs.simd_into(Scalar)) as i32)
    }
}
