        ...
        crate::kernel!(
            ...
            fn kernel(token: Sse2, a: f32x4<Sse2>) -> f32 {
                ...
                let reduced = {
                    ...
                    let shifted_is_nan = _mm_cmpunord_ps(shifted, shifted);
                    _mm_or_ps(
                        _mm_and_ps(shifted_is_nan, reduced),
                        _mm_andnot_ps(shifted_is_nan, intermediate),
                    )
                };
                let shifted = _mm_castsi128_ps(_mm_srli_si128::<4>(_mm_castps_si128(reduced)));
                let reduced = {
        ...
        crate::kernel!(
            ...
            fn kernel(token: Sse2, a: f64x2<Sse2>) -> f64 {
                ...
                let reduced = {
                    ...
                    let shifted_is_nan = _mm_cmpunord_pd(shifted, shifted);
                    _mm_or_pd(
                        _mm_and_pd(shifted_is_nan, reduced),
                        _mm_andnot_pd(shifted_is_nan, intermediate),
                    )
                };
                _mm_cvtsd_f64(reduced)
            }
