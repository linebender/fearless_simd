    ...
    Sized + Clone + Copy + Send + Sync + Seal + arch_types::ArchTypes + 'static
{
    ...
    #[doc = "Select elements from b and c based on the mask operand a.\n\nThis operation's behavior is unspecified if a was constructed from signed integer lanes that are neither all-zeroes nor all-ones. See the [`Select`] trait's documentation for more information."]
    ...
    + core::ops::Not<Output = Self>
{
    ...
    #[doc = r""]
    #[doc = r" False lanes are encoded as all zeroes, and true lanes are encoded as all ones."]
    type Element: SimdElement;
