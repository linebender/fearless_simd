    ...
    Sized + Clone + Copy + Send + Sync + Debug + Seal + arch_types::ArchTypes + 'static
{
    ...
    #[doc = r""]
    #[doc = r" This is useful for calling SIMD functions annotated `#[inline(always)]`"]
    #[doc = r" when you don't want to actually force inlining all the way up to a `dispatch!` call."]
    #[doc = r" `vectorize()` acts as the function boundary in machine code."]
    #[doc = r""]
    ...
    #[doc = r" # Example"]
    #[doc = r""]
    #[doc = r" `double_u32s_inner` is marked `#[inline(always)]`, but `double_u32s` is not."]
    #[doc = r" `vectorize()` creates a function boundary so the implementation does not have to be"]
    #[doc = r" inlined all the way into the `dispatch!` call."]
    #[doc = r""]
    #[doc = r" ```"]
    #[doc = r" use fearless_simd::{dispatch, prelude::*, Level};"]
    #[doc = r""]
    #[doc = r" #[inline(always)]"]
    #[doc = r" fn double_u32s_inner<S: Simd>(simd: S, values: &mut [u32]) {"]
    ...
    #[doc = r"         #[inline(always)]"]
    #[doc = r"         || double_u32s_inner(simd, values),"]
    #[doc = r"     );"]
    #[doc = r" }"]
    #[doc = r""]
    ...
    #[doc = r" Call function with SIMD instructions enabled."]
    #[doc = r""]
    #[doc = r" This is useful for creating SIMD functions that do not have to be annotated `#[inline(always)]`."]
    #[doc = r""]
    #[doc = r" `vectorize_inline()` will set the correct `#[target_feature]` annotations for the SIMD level."]
    #[doc = r" The provided function should be `#[inline(always)]`, otherwise it may not"]
    #[doc = r" be able to utilize the best SIMD instructions available."]
    #[doc = r""]
    #[doc = r" # Example"]
    ...
    #[doc = r" closure is inlined into the target-feature-enabled context created by `vectorize_inline()`."]
    #[doc = r""]
    #[doc = r" ```"]
    #[doc = r" use fearless_simd::{dispatch, prelude::*, Level};"]
    #[doc = r""]
    #[doc = r" fn double_u32s<S: Simd>(simd: S, values: &mut [u32]) {"]
    #[doc = r"     simd.vectorize_inline("]
    #[doc = r"         #[inline(always)]"]
    #[doc = r"         || {"]
    #[doc = r"             let mut chunks = values.chunks_exact_mut(S::u32s::N);"]
    #[doc = r"             for chunk in &mut chunks {"]
