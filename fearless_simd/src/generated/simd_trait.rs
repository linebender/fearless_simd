    ...
    Sized + Clone + Copy + Send + Sync + Debug + Seal + arch_types::ArchTypes + 'static
{
    ...
    #[doc = r""]
    #[doc = r" The experimental [`#[simd]`](https://docs.rs/fearless_simd_macros/latest/fearless_simd_macros/attr.simd.html)"]
    #[doc = r" attribute from the separate `fearless_simd_macros` crate performs this wrapping"]
    #[doc = r" automatically. Calling `vectorize()` directly is the dependency-free equivalent."]
    #[doc = r""]
    #[doc = r" # Example"]
    #[doc = r""]
